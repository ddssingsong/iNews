package com.jhs.inews.weather.model;
...
import com.jhs.inews.entity.WeatherBean;
import com.jhs.inews.utils.OkHttpUtils;
import com.jhs.inews.weather.WeatherJsonUtils;
...
public class WeatherModelImpl implements WeatherModel {
    ...
    public void loadWeatherData(String cityName, final LoadWeatherListener listener) {
        try {
            String url = WebInterface.WEATHER + URLEncoder.encode(cityName, "utf-8");
        ...
        OkHttpUtils.ResultCallback<String> callback = new OkHttpUtils.ResultCallback<String>() {
            ...
            public void onSuccess(String response) {
                ...
                if(TextUtils.isEmpty(city)) {
                    Log.e(TAG, "load location info failure.");
            ...
            @Override
            public void onFailure(Exception e) {
                Log.e(TAG, "load location info failure.", e);
    ...
    private String getLocationURL(double latitude, double longitude) {
        StringBuffer sb = new StringBuffer(WebInterface.INTERFACE_LOCATION);
